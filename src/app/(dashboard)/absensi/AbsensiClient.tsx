...
import { getAttendanceByDate, saveBulkAttendance } from '@/actions/attendanceActions';
...
export default function AbsensiClient() {
  ...
  const { data: serverRecords, isLoading, isError } = useQuery<StudentAttendanceRow[]>({
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 bg-zinc-900/30 border border-zinc-900/80 rounded-2xl p-4">
        ...
        <div className="flex items-center gap-2">
          <span className="text-xs text-zinc-500 font-semibold mr-1">Tandai Semua:</span>
            ...
            <Table>
              <TableHeader className="bg-zinc-900/50 border-b border-zinc-800">
                <TableRow className="border-b border-zinc-800 hover:bg-transparent">
                  ...
                  <TableHead className="w-[380px] text-center text-zinc-400 font-bold">Status Kehadiran</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
