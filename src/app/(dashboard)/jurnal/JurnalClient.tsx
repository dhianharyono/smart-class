  ...
  React.useEffect(() => {
    ...
    setDocHeader((prev) => {
      ...
      const shouldResetOldSlbDefault =
        ...
        school &&
        !school.toLowerCase().includes('purnama asih');

      if (shouldResetOldSlbDefault) {
        return {
          ...prev,
          schoolName: school,
          logoUrl: '/icon.svg',
