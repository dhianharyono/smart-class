...
import { createStudent, updateStudent, deleteStudent } from '@/actions/studentActions';
          ...
          <Table>
            <TableHeader className="bg-zinc-900/50 border-b border-zinc-800">
              <TableRow className="border-b border-zinc-800 hover:bg-transparent">
                ...
                <TableHead className="w-32 text-center text-zinc-400 font-bold">Aksi</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
                ...
                <TableRow>
                  <TableCell colSpan={6} className="h-32 text-center text-zinc-500">
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <p className="text-xs text-zinc-600">Klik "Tambah Siswa" untuk memulai.</p>
                    </div>
                  </TableCell>
                </TableRow>
              )}
      ...
      <Dialog open={addOpen} onOpenChange={setAddOpen}>
        <DialogContent className="bg-zinc-900 border border-zinc-800 text-white rounded-2xl max-w-md">
          <form onSubmit={handleAddSubmit}>
            <DialogHeader>
              <DialogTitle className="text-lg font-bold text-zinc-100">Tambah Siswa Baru</DialogTitle>
              <DialogDescription className="text-xs text-zinc-400">
                Input biodata siswa secara lengkap untuk melengkapi database kelas.
              </DialogDescription>
            </DialogHeader>
            <div className="space-y-4 py-4">
              <div className="space-y-1.5">
                <Label htmlFor="nis" className="text-zinc-300 text-sm font-semibold">NIS (Nomor Induk Siswa)</Label>
                <Input
                  id="nis"
                  required
              ...
              <div className="space-y-1.5">
                <Label htmlFor="name" className="text-zinc-300 text-sm font-semibold">Nama Lengkap</Label>
                <Input
                  id="name"
                  required
              ...
              <div className="space-y-1.5">
                <Label htmlFor="className" className="text-zinc-300 text-sm font-semibold">Kelas</Label>
                <Input
                  id="className"
                  required
              ...
              <div className="space-y-1.5">
                <Label className="text-zinc-300 text-sm font-semibold">Jenis Kelamin</Label>
                <Select
                  value={formData.gender}
                  onValueChange={(val) => val && setFormData({ ...formData, gender: val as 'L' | 'P' })}
                >
      ...
      <Dialog open={editOpen} onOpenChange={setEditOpen}>
        <DialogContent className="bg-zinc-900 border border-zinc-800 text-white rounded-2xl max-w-md">
          <form onSubmit={handleEditSubmit}>
            <DialogHeader>
              <DialogTitle className="text-lg font-bold text-zinc-100">Ubah Data Siswa</DialogTitle>
              <DialogDescription className="text-xs text-zinc-400">
            ...
            <div className="space-y-4 py-4">
              <div className="space-y-1.5">
                <Label htmlFor="edit-nis" className="text-zinc-300 text-sm font-semibold">NIS (Nomor Induk Siswa)</Label>
                <Input
                  id="edit-nis"
                  required
                  placeholder="Contoh: 2122101"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="edit-name" className="text-zinc-300 text-sm font-semibold">Nama Lengkap</Label>
                <Input
                  id="edit-name"
                  required
                  placeholder="Contoh: Ahmad Maulana"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="edit-className" className="text-zinc-300 text-sm font-semibold">Kelas</Label>
                <Input
                  id="edit-className"
                  required
                  placeholder="Contoh: X MIPA 1"
      ...
      <Dialog open={deleteOpen} onOpenChange={setDeleteOpen}>
        <DialogContent className="bg-zinc-900 border border-zinc-800 text-white rounded-2xl max-w-sm">
          <DialogHeader>
            ...
            <DialogTitle className="text-center text-lg font-bold text-zinc-100">Konfirmasi Hapus Siswa</DialogTitle>
            <DialogDescription className="text-center text-xs text-zinc-400">
              Apakah Anda yakin ingin menghapus <strong>{selectedStudent?.name}</strong>? Tindakan ini akan menghapus permanen semua data kehadiran, nilai, dan tabungan terkait siswa ini!
            </DialogDescription>
          </DialogHeader>
