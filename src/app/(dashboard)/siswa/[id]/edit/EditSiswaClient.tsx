...
export default function EditSiswaClient({ id }: { id: string }) {
  ...
  if (isLoading) {
    return (
      <div className='flex flex-col items-center justify-center py-24 text-slate-500'>
        ...
        <span className='text-xs font-semibold'>Memuat data biodata siswa...</span>
      </div>
    );
  }
      ...
      <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-slate-200/80 pb-4'>
        <div>
          <div className='flex items-center gap-2 text-xs font-semibold text-slate-600 mb-1.5 uppercase tracking-wider'>
            ...
            <span>&rsaquo;</span>
            <span className='text-emerald-700 font-bold'>Edit Biodata</span>
          </div>
          ...
          <p className='text-slate-600 text-xs sm:text-sm mt-1'>
            Perbarui data registrasi dan administrasi peserta didik.
          </p>
        </div>
