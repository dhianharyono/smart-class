...
export async function exportAttendanceToExcel(attendanceData: any[], dateStr: string) {
  const workbook = new ExcelJS.Workbook();
...
export async function exportGradesToExcel(gradesData: any[], subject: string, category: string) {
  const workbook = new ExcelJS.Workbook();
